package ru.home.weathbot_telegramBot;
...
public class WeathBotTelegramBot extends TelegramWebhookBot {
    ...
    public WeathBotTelegramBot(DefaultBotOptions botOptions, TelegramFacade telegramFacade) {
        super(botOptions);
